 ...
 */
public record Argon2dPasswordEncoderOption(
        int saltLength,
        int hashLength,
        int parallelism,
        int memory,
    ...
    public static Argon2idPasswordEncoderOptionBuilder fromDefaultBuilder() {
        Argon2idPasswordEncoderOptionBuilder builder = new Argon2idPasswordEncoderOptionBuilder();
    ...
    public static class Argon2idPasswordEncoderOptionBuilder {
        ...
        public Argon2PasswordEncoderOption build() {
            ...
            return new Argon2dPasswordEncoderOption(
                    saltLength,
                    hashLength,
                    parallelism,
                    memory,
